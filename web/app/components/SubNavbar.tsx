    ...
    <div className="w-full bg-white">
      <div className="w-full h-[38px] bg-white font-medium flex items-center border-b border-b-gray-100">
        <div className="md:px-4 px-4 w-full flex flex-row justify-between items-center">
          ...
          {onCreateAction && <button onClick={onCreateAction} className="text-xs flex flex-row items-center gap-1.5 text-gray-500 hover:text-gray-500 hover:bg-gray-200 px-2 py-1 rounded-sm bg-gray-100">
